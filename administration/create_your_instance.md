...
See [deploy](https://git.inventaire.io/inventaire-deploy) repo for a production ready setup.

See [docker](https://git.inventaire.io/docker-inventaire) repo for a Docker packaging.
